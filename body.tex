...
\caption{
  ...
  Red lines indicate links via alias which can be defined e.g. based on sequence similarity between
  genes.
...
%
In addition, we have created a pipeline, \href{https://github.com/plantinformatics/pretzel-input-generator}{\nolinkurl{https://github.com/plantinformatics/pretzel-input-generator}}), 
  to generate Pretzel-ready data from standard genome assembly formats in an automated way. This pipeline has been used to make available a set of publicly available genomes so users can quickly set up a Pretzel server populated with real data.
